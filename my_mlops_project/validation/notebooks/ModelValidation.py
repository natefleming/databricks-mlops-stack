...
#
# It runs as part of CD and by an automated model training job -> validation -> deployment job defined under ``my_mlops_project/databricks-resources/model-workflow-resource.yml``
#
#
# Parameters:
#
...
dbutils.widgets.text("model_name", "dev-my-mlops-project-model", "Model Name")
