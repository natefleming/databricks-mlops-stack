...
2. Update `my_mlops_project/databricks-resources/feature-engineering-workflow-resource.yml`. Fill in notebook parameters for `write_feature_table_job`.
3. Update training data path in `my_mlops_project/databricks-resources/model-workflow-resource.yml`.
...
Refer to [Local development and dev workspace](../my_mlops_project/databricks-resources/README.md#local-development-and-dev-workspace)
