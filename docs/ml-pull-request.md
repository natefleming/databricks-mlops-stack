...
* [Staging workspace registered model](https://adb-6850591417695172.12.azuredatabricks.net#mlflow/models/staging-my-mlops-project-model)
* [Prod workspace registered model](https://adb-6850591417695172.12.azuredatabricks.net#mlflow/models/prod-my-mlops-project-model)
