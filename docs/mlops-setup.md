...
[ML Config](../my_mlops_project/databricks-resources/README.md)  guides to make changes to ML code or deployed jobs.
...
```
git add README.md docs .gitignore my_mlops_project/databricks-resources/README.md
...
* You must be a Databricks workspace admin in the staging and prod workspaces. Verify that you're an admin by viewing the
  [staging workspace admin console](https://adb-6850591417695172.12.azuredatabricks.net#setting/accounts) and
  [prod workspace admin console](https://adb-6850591417695172.12.azuredatabricks.net#setting/accounts). If
...
Follow the instructions in [my-mlops-project/databricks-resources/README.md](../my_mlops_project/databricks-resources/README.md) to deploy ML resources
and production jobs.
...
[ML pull request guide](ml-pull-request.md) and [ML resource config guide](../my_mlops_project/databricks-resources/README.md)  to propose, test, and deploy
